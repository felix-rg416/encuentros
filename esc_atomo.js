let esc_atomo = {
  ...
  // Estado inicial: igual al estado final de "esc_anillo"
  ESTADO_INICIO: {
  ...
  // Estado final: formación "átomo" - mismo centro, mismo tamaño, cada una a 60° de diferencia
  // Puedes ajustar los grados de cada una para cambiar la orientación de la estrella
  ESTADO_FIN: {
    3: { cx: 0.50, cy: 0.50, rx: 0.15, ry: 0.40, rotacionGrados: 60 }, // otros
    2: { cx: 0.50, cy: 0.50, rx: 0.15, ry: 0.40, rotacionGrados: 0 },   // universidad
    1: { cx: 0.50, cy: 0.50, rx: 0.15, ry: 0.40, rotacionGrados: -60 }   // casa
  },
  ...
  dibujar: function (puntos, tamanoModulo) {
    ...
    for (let p of puntos) {
      ...
      let rot = radians(lerp(inicio.rotacionGrados, fin.rotacionGrados, t));
